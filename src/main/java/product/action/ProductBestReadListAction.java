...
public class ProductBestReadListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ArrayList<Product> productList = productListService.getProductBestReadList();
		...
		productList = productListService.getProductBestReadList();
		
		
		request.setAttribute("productList", productList);
	    request.setAttribute("pagefile", "/product/productBestReadList.jsp");
