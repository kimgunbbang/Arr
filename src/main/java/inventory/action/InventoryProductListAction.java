...
public class InventoryProductListAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ArrayList<Inventory> inventoryList = inventoryListService.inventoryProductList();
		...
		request.setAttribute("state", "invenStatus");
